  ...
  <body>
    ...
    <?php
      ...
      if($_SESSION["acces"]==1){
        ...
        <li><a class='navadmin' href='profil'><img id='profil' src='../styles/images/profil.png' alt='profil'/></a></li>");
        ...
        echo('<li><a class="navuser" href="profil"><img id="profil" src="../styles/images/profil.png" alt="profil"/></a></li>');
