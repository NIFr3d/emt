<html lang="fr">
  ...
  <body>
    ...
    <?php
      session_start();
      if($_SESSION["acces"]==1){
        echo('<form method="post" action="index.php" class="nav"><button type="submit" class="boutonNav"><img id="accueil" src="../styles/images/accueil.png" alt="accueil"/> Accueil</button></form>');
        echo("<form method=\"post\" action=\"historique.php\" class=\"nav\"><button type=\"submit\" class=\"boutonNav\">Historique des courses</button></form>
        ...
        echo('<form method="post" action="index.php" class="nav2"><button type="submit" class="boutonNav"><img id="accueil" src="../styles/images/accueil.png" alt="accueil"/> Accueil</button></form>');
        echo("<form method=\"post\" action=\"historique.php\" class=\"nav2\"><button type=\"submit\" class=\"boutonNav\">Historique des courses</button></form>");
