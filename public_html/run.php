<html lang="fr">
  ...
  <body>
    ...
    echo("<TABLE BORDER='1' cellspacing='0'> 
        <TR><TH>Temps (s)</TH><TH>Vitesse (km/h)</TH><TH>Vitesse moyenne (km/h)</TH><TH>Intensité (A)</TH><TH>Tension (V)</TH><TH>Energie (J)</TH><TH>Latitude (DD)</TH><TH>Longitude (DD)</TH><TH>Aller à</TH><TH>Altitude (DD)</TH><TH>Tour</TH></TR>\n");
